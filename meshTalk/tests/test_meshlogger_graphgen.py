...
from meshtools import graphGen
from meshtools import meshLogger
...
class MeshLoggerGraphGenTests(unittest.TestCase):
    def test_meshlogger_update_db_returns_existing_snapshot_on_empty_fetch(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            with mock.patch("meshtools.meshLogger.fetch_nodes_json", return_value=None), mock.patch("meshtools.meshLogger.fetch_info_raw", return_value=None):
    ...
    def test_meshlogger_update_db_falls_back_to_info_nodes_dict(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            with mock.patch("meshtools.meshLogger.fetch_nodes_json", return_value=None), mock.patch(
                "meshtools.meshLogger.fetch_info_raw",
                return_value='{"nodesById":{"!87654321":{"user":{"id":"!87654321","longName":"Node B","shortName":"B"}}}}',
            ), mock.patch("meshtools.meshLogger.parse_nodes_block", return_value=nodes_from_info):
